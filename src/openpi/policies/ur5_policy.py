...
def make_ur5e_example() -> dict:
    ...
    return {
        ...
        "scene_image": np.random.randint(256, size=(240, 320, 3), dtype=np.uint8),
        "wrist_image": np.random.randint(256, size=(240, 320, 3), dtype=np.uint8),
        "prompt": "do something",
    }
...
class UR5Inputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        base_image = _parse_image(data["scene_image"])
